...
var kIsProxy = /* @__PURE__ */ Symbol("kIsProxy");
...
function loadNapiModuleImpl(loadFn, userNapiModule, wasmInput, options) {
  ...
  return loadFn(wasmInput, importObject, function(err, source) {
    ...
    var memory = getMemory2 ? getMemory2(originalExports) : exportMemory ? originalExports.memory : importMemory ? importObject.env.memory : void 0;
    if (!memory) {
...
var REGULAR_FILE_BASE = WasiRights.FD_DATASYNC | WasiRights.FD_READ | WasiRights.FD_SEEK | WasiRights.FD_FDSTAT_SET_FLAGS | WasiRights.FD_SYNC | WasiRights.FD_TELL | WasiRights.FD_WRITE | WasiRights.FD_ADVISE | WasiRights.FD_ALLOCATE | WasiRights.FD_FILESTAT_GET | WasiRights.FD_FILESTAT_SET_SIZE | WasiRights.FD_FILESTAT_SET_TIMES | WasiRights.POLL_FD_READWRITE;
var REGULAR_FILE_INHERITING = /* @__PURE__ */ BigInt(0);
var DIRECTORY_BASE = WasiRights.FD_FDSTAT_SET_FLAGS | WasiRights.FD_SYNC | WasiRights.FD_ADVISE | WasiRights.PATH_CREATE_DIRECTORY | WasiRights.PATH_CREATE_FILE | WasiRights.PATH_LINK_SOURCE | WasiRights.PATH_LINK_TARGET | WasiRights.PATH_OPEN | WasiRights.FD_READDIR | WasiRights.PATH_READLINK | WasiRights.PATH_RENAME_SOURCE | WasiRights.PATH_RENAME_TARGET | WasiRights.PATH_FILESTAT_GET | WasiRights.PATH_FILESTAT_SET_SIZE | WasiRights.PATH_FILESTAT_SET_TIMES | WasiRights.FD_FILESTAT_GET | WasiRights.FD_FILESTAT_SET_TIMES | WasiRights.PATH_SYMLINK | WasiRights.PATH_UNLINK_FILE | WasiRights.PATH_REMOVE_DIRECTORY | WasiRights.POLL_FD_READWRITE;
var DIRECTORY_INHERITING = DIRECTORY_BASE | REGULAR_FILE_BASE;
var SOCKET_BASE = WasiRights.FD_READ | WasiRights.FD_FDSTAT_SET_FLAGS | WasiRights.FD_WRITE | WasiRights.FD_FILESTAT_GET | WasiRights.POLL_FD_READWRITE | WasiRights.SOCK_SHUTDOWN;
var SOCKET_INHERITING = RIGHTS_ALL;
var TTY_BASE = WasiRights.FD_READ | WasiRights.FD_FDSTAT_SET_FLAGS | WasiRights.FD_WRITE | WasiRights.FD_FILESTAT_GET | WasiRights.POLL_FD_READWRITE;
...
var WASI$1 = class _WASI$1 {
  constructor(args, env, fds, asyncFs, fs, asyncify) {
    ...
    defineImport("path_open", function path_open(dirfd, dirflags, path, path_len, o_flags, fs_rights_base, fs_rights_inheriting, fs_flags, fd) {
      ...
      const wrap2 = wasi.fds.insert(r, resolved_path, resolved_path, filetype, fs_rights_base & max_base, fs_rights_inheriting & max_inheriting, 0);
...
var kExitCode = /* @__PURE__ */ Symbol("kExitCode");
var kSetMemory = /* @__PURE__ */ Symbol("kSetMemory");
var kStarted = /* @__PURE__ */ Symbol("kStarted");
var kInstance = /* @__PURE__ */ Symbol("kInstance");
var kBindingName = /* @__PURE__ */ Symbol("kBindingName");
...
var parse = __napiModule.exports.parse;
